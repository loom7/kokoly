...
| 31.08.2026 | **M6-Lizenzrecherche (16 Agenten, Web, adversarial gegengeprüft — alle Kernaussagen haltbar):** Martin-Kette an allen vier erreichbaren Gliedern revisionsgepinnt Apache-2.0 (Godelaune a1cba7f…, kikiri-martin 1e9dcd1…, kikiri-base 0d15d02…, hexgrad f3ff357…); Restunschärfen ehrlich im Dossier (keine LICENSE-Dateien, dida-80b-Vorstufe verschwunden, Stimmprovenienz „Martin Harbecke (synthetic)" unbelegt). espeak-1.52.0-Notices präzisiert: gebündelt nur C-Kern (GPL-3.0-or-later) + ucd-tools (Unicode License); Sonic/speechPlayer/Klatt/getopt sind per Build-Option AUS. F-Droid: aufnahmefähig — Maven-Central-AAR policy-gedeckt, Modell-Nachladen = Anti-Feature NonFreeNet mit Präzedenzfällen SherpaTTS/WhisperIME/RHVoice | docs/lizenz/martin-kette.md + belege/, docs/recherche/f-droid.md |
| 31.08.2026 | **F1 entschieden — Mittelweg:** Martin-Bezug bleibt bei der revisionsgepinnten HF-Quelle (nur Verlinken); zwei Sicherungskopien beider Dateien prüfsummenverifiziert angelegt (c302f1d8…, 5b9c8553… == models.json), Umschwenkplan auf Selbstverteilung binnen eines Tages im Dossier. Anlass: die dida-80b-Vorstufe derselben Kette ist bereits verschwunden — Quellenausfall ist kein theoretisches Risiko | sha256sum beider Kopien, docs/lizenz/martin-kette.md |
