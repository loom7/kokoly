...
flowchart TB
    subgraph SVC["Dienst-Schicht (Kotlin)"]
        ...
        SET["Einstellungen (settingsActivity, auch Starter-Eintrag)<br/>Erstlauf: Sprachüberblick + Deutsch-Download-Frage<br/>Bevorzugt-Status + Sprung zu den System-TTS-Einstellungen<br/>Sprachen an/ab · Modell-Download · Über/Lizenz<br/>Theme.Kokoly folgt System-Tag/Nacht"]
